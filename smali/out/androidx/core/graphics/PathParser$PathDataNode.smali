...
.method private static addCommand(Landroid/graphics/Path;[FCC[F)V
    ...
    sparse-switch v11, :sswitch_data_400
    ...
    if-eq v11, v2, :cond_32a

    const/16 v3, 0x56

    if-eq v11, v3, :cond_318

    const/16 v3, 0x61

    if-eq v11, v3, :cond_2c1

    const/16 v3, 0x63

    if-eq v11, v3, :cond_287

    const/16 v4, 0x68

    if-eq v11, v4, :cond_276

    const/16 v4, 0x71

    if-eq v11, v4, :cond_246
    ...
    if-eq v11, v1, :cond_21d

    const/16 v1, 0x4d

    if-eq v11, v1, :cond_1ee

    const/16 v1, 0x53

    const/high16 v5, 0x40000000    # 2.0f

    if-eq v11, v1, :cond_1a1
    ...
    if-eq v14, v3, :cond_1b3

    const/16 v3, 0x73

    if-eq v14, v3, :cond_1b3

    if-eq v14, v0, :cond_1b3
